...
return [
    'ctrl' => [
        ...
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'title' => 'LLL:EXT:smedia_frontend/Resources/Private/Language/locallang_db.xlf:tt_content.tx_smediafrontend_model_item',
        'delete' => 'deleted',
        'versioningWS' => true,
        'origUid' => 't3_origuid',
        'hideTable' => true,
    ...
    'palettes' => [
        ...
        'visibility' => [
            'showitem' => '
                hidden;LLL:EXT:smedia_frontend/Resources/Private/Language/Backend.xlf:tt_content.tx_smediafrontend_model_item,
            '
        ],
    ...
    'columns' => [
        'tt_content' => [
            'exclude' => true,
            'label' => 'LLL:EXT:smedia_frontend/Resources/Private/Language/locallang_db.xlf:tt_content.tx_smediafrontend_model_item',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'foreign_table' => 'tt_content',
                'foreign_table_where' => 'AND tt_content.pid=###CURRENT_PID### AND tt_content.{#CType}=\'model\'',
                'maxitems' => 1,
                'default' => 0
            ]
        ],
        ...
        'l18n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_smediafrontend_model_item',
                'foreign_table_where' =>
                    'AND {#tx_smediafrontend_model_item}.{#pid}=###CURRENT_PID###'
                    . ' AND {#tx_smediafrontend_model_item}.{#sys_language_uid} IN (-10)',
                'default' => 0
            ]
        ],
        'l10n_source' => [
