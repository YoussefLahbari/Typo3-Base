...
$GLOBALS['TCA']['tx_smediafrontend_similar_item']['ctrl']['security']['ignorePageTypeRestriction'] = true;
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'label' => 'LLL:EXT:smedia_frontend/Resources/Private/Language/locallang_be.xlf:content_element.similar',
        'value' => $elementKey,
        'icon' => $icon,
        'group' => $extensionKey,
    ]
    ...
    [
        'showitem' => '
            --div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:general,
                ...
                tx_smediafrontend_similar_item,
...
$GLOBALS['TCA']['tt_content']['columns'] = array_replace_recursive(
    ...
    [
        'tx_smediafrontend_similar_item' => [
            'label' => 'LLL:EXT:smedia_frontend/Resources/Private/Language/Backend.xlf:tt_content.tx_smediafrontend_similar_item',
            'config' => [
                'type' => 'inline',
