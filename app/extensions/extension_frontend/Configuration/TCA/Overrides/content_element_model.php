...
$GLOBALS['TCA']['tx_smediafrontend_model_item']['ctrl']['security']['ignorePageTypeRestriction'] = true;
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'label' => 'LLL:EXT:smedia_frontend/Resources/Private/Language/locallang_be.xlf:content_element.model',
        'value' => $elementKey,
        'icon' => $icon,
        'group' => $extensionKey,
    ]
...
$GLOBALS['TCA']['tt_content']['columns'] = array_replace_recursive(
    ...
    [
        'tx_smediafrontend_model_item' => [
            'label' => 'LLL:EXT:smedia_frontend/Resources/Private/Language/Backend.xlf:tt_content.tx_smediafrontend_model_item',
            'config' => [
                'type' => 'inline',
