...
$GLOBALS['TCA']['tx_smediafrontend_service_item']['ctrl']['security']['ignorePageTypeRestriction'] = true;
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'label' => 'LLL:EXT:smedia_frontend/Resources/Private/Language/locallang_be.xlf:content_element.service',
        'value' => $elementKey,
        'icon' => $icon,
        'group' => $extensionKey,
    ]
    ...
    [
        'showitem' => '
            --div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:general,
                ...
                tx_smediafrontend_service_item,
...
$GLOBALS['TCA']['tt_content']['columns'] = array_replace_recursive(
    ...
    [
        'tx_smediafrontend_service_item' => [
            'label' => 'LLL:EXT:smedia_frontend/Resources/Private/Language/Backend.xlf:tt_content.tx_smediafrontend_service_item',
            'config' => [
                'type' => 'inline',
